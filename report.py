...
def tradeoff_plots(to2v_ratio_list, carrier_proportion_list, takeover_time_list, runs):
    ...
    for cp in carrier_proportion_list:
        ...
        # df_avg.plot()
        sns.lineplot(data=df_carrier_proportions[cp], x="TO2vehicle_ratio", y="AVG_queue_time", hue="TO_takeover_time", alpha=0.7)
        plt.xlabel('Teleoperator-to-vehicle ratio')
        ...
        # df_max.plot()
        sns.lineplot(data=df_carrier_proportions[cp], x="TO2vehicle_ratio", y="Max_queue_time", hue="TO_takeover_time", alpha=0.7)
        plt.xlabel('Teleoperator-to-vehicle ratio')
        ...
        # df_vav.plot()
        sns.lineplot(data=df_carrier_proportions[cp], x="TO2vehicle_ratio", y="AVG_queue_per_vehicle", hue="TO_takeover_time", alpha=0.7)
        plt.xlabel('Teleoperator-to-vehicle ratio')
